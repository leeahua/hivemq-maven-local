...
public interface AsyncSubscriptionStore {
    ...
    /**
     * This method returns all subscriptions on this HiveMQ Node as a {@link Multimap} of client identifiers and topics.
     ...
     *
     * @return a {@link ListenableFuture} which contains a {@link Multimap} of client identifiers and their topic subscriptions
     */
    @ReadOnly
     ...
     * @return A {@link ListenableFuture} object that will succeed,
     ...
     * as a {@link Multimap} of client identifiers and topics.
     * <p>
     * Please be aware that calling this method on HiveMQ instances with many subscriptions could have
     * negative performance effects.
     * <p>
