...
public interface AsyncClientService {
     ...
     * effects.
     *
     * @return a {@link ListenableFuture} which contains all client identifiers of all connected clients
     */
     ...
     *
     * @return a {@link ListenableFuture} which contains the client identifiers of all disconnected clients with a persistent MQTT session
     */
     ...
     * @return a {@link ListenableFuture} which contains true, if a certain client is currently connected and false otherwise
     */
     ...
     * @return a {@link ListenableFuture} which contains the {@link ClientData} for a specific client.
     */
     ...
     *
     * @return a {@link ListenableFuture} which contains the client identifiers of all connected clients
     */
     ...
     * Disconnected MQTT clients which don't have a persistent session won't be returned by this method
     *
     * @return a {@link ListenableFuture} which contains the of client identifiers of all disconnected clients with a persistent MQTT session
     */
